...
public class PhotoshareStartup extends HttpServlet {
	...
	public void init() throws ServletException {
		...
		//Creates db if the config is set to create else will perform the operation accordingly
		//we will be performing this oepration here so it won't take much time when a first db 
